...
export function initElements() {
    Object.assign(el, {
        ...
        chatContextLabel: document.getElementById('chat-context-label'),
        ...
        lorebookContextLabel: document.getElementById('lorebook-context-label'),
...
export const icons = {
    ...
    REGEN:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"></polyline><path d="M3.51 15a9 9 0 1 0 .49-4.5"></path></svg>`,
