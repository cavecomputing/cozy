...
export function initElements() {
    Object.assign(el, {
        ...
        settingsAdvancedToggle: document.getElementById('settings-show-advanced-toggle'),
        ...
        promptBasicHint:     document.getElementById('settings-prompt-basic-hint'),
        promptEnableAdvanced: document.getElementById('settings-prompt-enable-advanced'),
        postHistoryContent:  document.getElementById('settings-posthistory-content'),
        promptRenderedBtn:    document.getElementById('prompt-rendered-btn'),
        promptRenderedFlyout: document.getElementById('prompt-rendered-flyout'),
        promptRenderedBody:   document.getElementById('prompt-rendered-body'),
        ...
        regexPresetSelect:   document.getElementById('settings-regex-preset-select'),
        regexPresetNew:      document.getElementById('settings-regex-new'),
        regexPresetDelete:   document.getElementById('settings-regex-delete'),
        regexIoDropdown:     document.getElementById('regex-io-dropdown'),
        regexIoBtn:          document.getElementById('settings-regex-io-btn'),
        regexIoMenu:         document.getElementById('regex-io-menu'),
        regexImport:         document.getElementById('settings-regex-import'),
        regexExport:         document.getElementById('settings-regex-export'),
        regexImportFile:     document.getElementById('settings-regex-import-file'),
        regexHelpBtn:        document.getElementById('settings-regex-help'),
        regexHelpModal:      document.getElementById('regex-help-modal'),
        regexHelpClose:      document.getElementById('regex-help-close'),
        regexFilterList:     document.getElementById('settings-regex-filters'),
        regexFilterCount:    document.getElementById('settings-regex-count'),
        ...
        apiHelpBtn:        document.getElementById('settings-api-help'),
        apiHelpModal:      document.getElementById('api-help-modal'),
        apiHelpClose:      document.getElementById('api-help-close'),
        lorebookHelpBtn:   document.getElementById('settings-lorebook-help'),
        lorebookHelpModal: document.getElementById('lorebook-help-modal'),
        lorebookHelpClose: document.getElementById('lorebook-help-close'),
        summaryHelpBtn:    document.getElementById('settings-summary-help'),
        summaryHelpModal:  document.getElementById('summary-help-modal'),
        summaryHelpClose:  document.getElementById('summary-help-close'),
